...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, _______, KC_MPRV, KC_MSEL, KC_MPLY, KC_MNXT
),
...
[_FUNCTION] = LAYOUT_preonic_grid(
  XXXXXXX,      DYN_MACRO_PLAY1, DYN_MACRO_PLAY2, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX,  XXXXXXX,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
        ...
        case DVORAK: // Set default layout to DVORAK
          ...
          return false;
          break;
        case LOWER: // Change layer to LOWER / ADJUST
          if (record->event.pressed) {
            layer_on(_LOWER);
          ...
          return false;
          break;
        case RAISE: // Change layer to RAISE / ADJUST
          if (record->event.pressed) {
            layer_on(_RAISE);
